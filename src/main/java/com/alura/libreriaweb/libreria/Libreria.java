package com.alura.libreriaweb.libreria;

import com.alura.libreriaweb.ConsumoAPI_confi.Consumo_api;
import com.alura.libreriaweb.ConsumoAPI_confi.ConvertirDatos;
import com.alura.libreriaweb.Items.Autor;
import com.alura.libreriaweb.Items.Libro;
import com.alura.libreriaweb.Items.LibrosRespuestaAPI;
...
public class Libreria {
    ...
    private Consumo_api consumoApi = new Consumo_api();
    ...
    public Libreria(libro_repositorio libroRepository, Autor_Repository autorRepository) {
    ...
    private Libro getDatosLibro(){
        ...
        if (datos != null && datos.getResultadoLibros() != null && !datos.getResultadoLibros().isEmpty()) {
            DatosLibros primerLibro = datos.getResultadoLibros().get(0); // Obtener el primer libro de la lista
