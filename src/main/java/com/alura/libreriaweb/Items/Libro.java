...
import com.alura.libreriaweb.Items.Records.Media;
import com.alura.libreriaweb.datos.Generos;
...
public class Libro {
    ...
    private Generos generoModificado(List<String> generos) {
        ...
        Optional<String> firstGenero = generos.stream()
                ...
                .findFirst();
        return firstGenero.map(Generos::fromString).orElse(Generos.DESCONOCIDO);
    }
